...
The developed object detection method is validated in Webots simulation [vision_pick_and_place.wbt](../webots/object_recognition_project/worlds/vision_pick_and_place.wbt). Video of the simulation is uploaded to YouTube:

[![Simulation Video](https://img.youtube.com/vi/QVlyeqYyYI8/default.jpg)](https://youtu.be/QVlyeqYyYI8)
